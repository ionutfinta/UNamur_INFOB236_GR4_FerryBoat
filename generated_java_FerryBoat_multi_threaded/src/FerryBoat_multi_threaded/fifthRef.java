...
public class fifthRef{
	...
	public fifthRef(){
		...
		events[0] = new BoardLift(this);
		events[1] = new Reserve(this);
		events[2] = new Switch_lift_access(this);
		events[3] = new Sensor_stops_detecting(this);
		events[4] = new MoveLift(this);
		events[5] = new Vehicle_auth_on(this);
		events[6] = new Boat_leave(this);
		events[7] = new Switch_lvl_2_access(this);
		events[8] = new Sensor_detects(this);
		events[9] = new Switch_lvl_1_access(this);
		events[10] = new Switch_lvl_3_access(this);
		events[11] = new LeaveLift(this);
		events[12] = new Unboard(this);
		events[13] = new Board(this);
		events[14] = new Switch_lift_out(this);
		events[15] = new Boat_ready(this);
		events[16] = new Vehicle_in(this);
		events[17] = new Vehicle_out(this);
		events[18] = new Switch_lift_in(this);
